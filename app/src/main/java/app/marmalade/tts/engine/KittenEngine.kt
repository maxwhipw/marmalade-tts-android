...
open class KittenEngine @Inject constructor(
    ...
    companion object {
        ...
        // released `kitten-nano-en-v0_8-int8.tar.bz2` layout — keep in sync
     ...
     * documented kitten-nano constant (24 kHz) otherwise. The fallback
     * matters for the system-TTS callback path, which has to declare a
     * sample rate before any synthesis happens.
     */
    open val sampleRate: Int get() = tts?.sampleRate() ?: KittenVoiceCatalog.SAMPLE_RATE
